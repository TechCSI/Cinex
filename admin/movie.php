...
<div id="wrapper">
	...
	<div id="main">
		<div id="operation">
			<div id="add"><a href="addmovie.php">Add Movie</a></div>
			<div id="delete"><a href="deletemovie.php">Delete Movie</a></div>
			<div id="update"><a href="updatemovie.php">Update Movie</a></div>
		</div>
