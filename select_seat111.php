  ...
  ?>
         ...
         <div id="booking-process">
             <div id="book_movie">
                 <h2>Movie Info</h2>
                 <div>
                     <img src="admin/image/kaabil.jpg">
                     <br><br>
                     <label>Kaabil</label><b>U/A</b><hr>
                     <label>Hindi</label><label>APR CITY CENTER</label> <br><br>
                     <label>22-02-2017</label>
                     <label>Morning</label><br><br>
                 </div>
             </div>
             <div id="seat-select">
                 <h2 align="center">:::::: Select Seat ::::::</h2>
                    <?php block_seat();?>
                 <form action="" method="post">
                     <table width="40" border="1" cellspacing="5" cellpadding="1">
                 ...
                 if(isset($_POST['submit'])){
                     ...
                     if(isset($_POST['seat'])){
                         ...
                         if($res){
                             ...
                             /*
                             header("Location:payment.php?tid=$last_id")
                     */
        ...
        ?>
             ...
             <div id="seat_checkout">
                 ...
                 <div style="width: 100%">
                    <b> Selected :</b><label id="selectseat"style="color:white;background-color: orange;padding:5px"></label><br><br><br>
                    <b> Amount : </b><label id="selectseatamount"style="color:white;background-color: red;padding:5px"></label>
                 </div>

                 <center>
                     <h2>Your Information</h2>
                     <input type="text" name="mobile" tabindex="2" placeholder="Enter your Mobile No." required ><br><br>
                     <input type="email" name="email" tabindex="2" placeholder="Enter Your Email" required><br><br>
